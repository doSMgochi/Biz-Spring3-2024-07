document.addEventListener("DOMContentLoaded", () => {
  ...
  // 함수를 한 번만 사용하고 다른 곳에서는 더 이상 사용하지 않을 것이다 라는 예측으로 제작
  // 익명 함수로 handler 를 선언하는 것을 Call Back 함수 선언 이라고도 한다.
  btn_delete?.addEventListener("click", (e) => {
    if (confirm("정말 학생 정보를 삭제할까요?")) {
      // 클릭된 (delete button) 의 부모 중에서 가장 가까이 있는 div 로부터
