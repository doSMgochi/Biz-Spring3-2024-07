...
<script src="https://kit.fontawesome.com/4245727789.js"
	crossorigin="anonymous"></script>
<script src="${rootPath }/static/js/list.js"></script>
</head>
<body>
	<h1>오늘은 내 인생의 가장 젊은 날</h1>
		...
		<article class="list">
			...
			<ul class="memo-list">
				<c:forEach items="${MEMOS }" var="MEMO">
					<li data-seq="${MEMO.m_seq }"><i class="fa-solid fa-user">
					</i><i> &#128512;</i> <span> ${MEMO.m_subject }</span><i class="delete">&times;</i></li>
				</c:forEach>
			</ul>
		</article>
	...
	<footer>
		<address>CopyRight &copy; dosmgochi.dev@gmail.com</address>
	</footer>
</body>
</html>