...
public class HomeController {
	 ...
	 * Controller 등에서 사용하기 위해서는 먼저 Service 클래스에 @Service Annotation 을 부착하여 Spring
	 * Server 가 시작될 때 Scan 하도록 하여두고 필요한 곳에서 생성자를 통하여 주입받도록 사용한다. 필요한 곳에서 필요하다고 선언만
	 * 해두면, 생성된 객체를 자동으로 공급(주입)해준다. 기존의 자바 코드와 비교하면 객체를 생성하는 방향이 반대이다. 이러한 것을 제어의
	 * 역전(Inverted of Control, IoC) 라고 한다.
	 */
